...
<html>
    ...
    <body>
		...
		<?php
		    ...
		    // loop through all entre menu items and print them to the screen
		...
		<div class="container">
            	<form valign="bottom" action="specRequest.php" method="POST">
			<br><br>
			<p text-color="white">Any special requests or allergies?</p>
			<input type="text" name="special_request" size="100" maxlength="100">
			<br>
