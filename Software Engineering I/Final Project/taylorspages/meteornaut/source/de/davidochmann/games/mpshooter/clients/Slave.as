package de.davidochmann.games.mpshooter.clients
{
	...
	public class Slave implements IClient
	{
		...
		public function Slave(pStage:Stage, pPeerConnection:PeerConnection = null)
		{
			setStage(pStage);
		...
		{	
			mPeerObject.updateMasterToSlave(mData);
		}
		...
		{
			mMover = new Mover(mStage, Mover.CLIENT_SLAVE);
		}
