...
Name:	Jason Hoang
Course:	CSCE 3110
Assignment:	PROGRAM 3 - Binary Search Trees - PART B
Due Date:	7-17-2015
****************/
...
int AlternateIndex(1);	//global variable to keep track of Alternating between Left Tree and Right Tree Recursion
using namespace std;
...
int main()
{
	...
	cout << "\nAlterateIndex = " << AlternateIndex << endl;
...
void BinaryTree::remove(int value, node*& leaf)
{
	...
	else 	//if (node-key == key) and 1 child or no children - DELETE
	{
		...
		else			//FINAL DELETION -- end of recursive deletion
		{
			...
			//increment AlternateIndex to Alternate between even and odd numbers			
			::AlternateIndex++;	
			return;
		}
        }
